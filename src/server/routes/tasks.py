...
@router.get("/tasks/", status_code=status.HTTP_200_OK, response_model=GetAllResult, summary="Retrieves all tasks "
                                                                                            "listed on the tasks.json "
                                                                                            "file")
...
@router.get("/tasks/{id}", status_code=status.HTTP_200_OK, response_model=Task, summary="Retrieves information from a "
                                                                                        "single task.")
